    ...
    submit(){
        for(this.eachUser of this.userList){
          if(this.uname == this.eachUser[1].username && this.pword == this.eachUser[1].password){
            ...
            let logedUser = new userClass(this.eachUser[1].id, this.eachUser[1].first_name, this.eachUser[1].last_name, this.eachUser[1].username, this.eachUser[1].email,this.eachUser[1].membership, this.eachUser[1].seller, this.eachUser[1].manager)
